              ...
              <div class="card-body">
                <table id="admin-table" class="table table-bordered table-striped table-hover">
                  <thead>
                    <tr>
                      <td>STT</td>
                      <td class="w-50">Thông tin slider	</td>
                      <td>Trạng thái	</td>
                      <td>Ngày tạo</td>
                    ...
                    @foreach($data as $key => $value)
                      <tr id="row-{{$value->id}}">
                        ...
                        <td>
                          ...
                          <p> <b>Link: </b> <a href="{{$value->link}}" target="_blank" class="link">{{$value->link}}</a>   </p> 
                          <p> <b>Mô tả: </b> <span class="description">{{$value->description}}</span>  </p> 
