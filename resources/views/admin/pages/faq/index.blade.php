                  ...
                  <tbody>
                    @foreach($data as $key => $value)
                      <tr id="row-{{$value->id}}">
                        ...
                        <td class="anwser"> {{$value->anwser}}</td>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="POST" action="{{route($prefix.'.store')}}" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal form-label-left" id="main-form">
            ...
            <div class="form-group">
              <label for="anwser" >Câu trả lời</label>
              <textarea class="form-control" name="anwser"  cols="30" rows="5"></textarea>
          </div>
            <div class="form-group">
        ...
        <div class="modal-body">
          <form id="form-edit" method="POST" action="{{route($prefix.'.update',0)}}" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal form-label-left">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <label for="anwser" >Câu trả lời</label>
                <textarea class="form-control" name="anwser"  cols="30" rows="5" id="anwser"></textarea>
            </div>
            <div class="form-group">
                <label for="status" class="control-label">Status</label>
  ...
  @section('js')
      <script>
        ...
        $('.btn-edit').click(function() {
            ...
            let question        = rowParent.find(".question");
            let anwser          = rowParent.find(".anwser");
