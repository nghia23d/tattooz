                  ...
                  <tbody>
                    @foreach($data as $key => $value)
                      <tr id="row-{{$value->id}}">
                        ...
                        <td> <img class="img-fluid thumb" src="{{asset('admin/images/'.$prefix."/$value->thumb")}}" alt="{{$value->thumb}}"></td>
                        <td> <span class="category_id" data-category_id="{{$value->category_id}}">{{$value->category->name}}</span></td>
  ...
  @section('js')
      <script>
        ...
        $('.btn-edit').click(function() {
            ...
            let category_id     = rowParent.find(".category_id");
            ...
            $('#category_id').val(category_id.data('category_id'));
        });
